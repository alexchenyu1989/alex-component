...
export default function HomePage() {
  ...
  const setCategory = (val) => setSearchParams({ category: val, tag, search })
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0B] text-white flex flex-col" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      {/* Topbar */}
      <header
        className="shrink-0 sticky top-0 z-20 flex items-center justify-between px-10 h-16"
      ...
      >
        ...
        <form onSubmit={handleSearch} className="relative">
          ...
          <input
            ...
            placeholder="搜尋元件..."
            className="h-9 w-[280px] rounded-lg pl-9 pr-4 text-sm text-white outline-none"
            style={{
              background: '#1A1A1D',
      ...
      <div className="flex flex-1">
        {/* Sidebar */}
        <aside
          className="w-[260px] shrink-0 sticky top-16 self-start min-h-[calc(100vh-4rem)] flex flex-col"
